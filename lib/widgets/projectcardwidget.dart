...
class _ProjectCardWidgetState extends State<ProjectCardWidget> {
  ...
  final List<Color> _technologyColors = List.filled(technologyItems.length, CustomColor.whiteSecondary);
        ...
        child: Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  MouseRegion(
                    onEnter: (_) {
                      setState(() {
                        _titleColor = CustomColor.yellowSecondary; // Change color on hover
                      });
                    },
                    onExit: (_) {
                      setState(() {
                        _titleColor = CustomColor.whitePrimary; // Reset color on hover exit
                      });
                    },
                    child: Text(
                      widget.project.name,
                  ...
                  Row(
                    children: [
                      MouseRegion(
                        onEnter: (_) {
                          setState(() {
                            _linkTextColor = CustomColor.yellowSecondary; // Change color on hover
                          });
                        },
                        onExit: (_) {
                          setState(() {
                            _linkTextColor = CustomColor.whitePrimary; // Reset color on hover exit
                          });
                        },
                        child: Text(
                          "Link:",
            ...
            MouseRegion(
              onEnter: (_) {
                setState(() {
                  _descriptionColor = CustomColor.yellowSecondary; // Change color on hover
                });
              },
              onExit: (_) {
                setState(() {
                  _descriptionColor = CustomColor.whitePrimary; // Reset color on hover exit
                });
              },
                    ...
                    children: [
                      for (int i = 0; i < technologyItems.length; i++)
                        MouseRegion(
                          onEnter: (_) {
                            setState(() {
                              _technologyColors[i] = CustomColor.yellowSecondary; // Change color on hover
                            });
                          },
                          onExit: (_) {
                            setState(() {
                              _technologyColors[i] = CustomColor.whiteSecondary; // Reset color on hover exit
                            });
                          },
                          child: Chip(
                            ...
                            shape: StadiumBorder(
                              side: BorderSide(color: _technologyColors[i]), // Apply hover color to border
                            ),
                          ),
                        ),
                    ],
